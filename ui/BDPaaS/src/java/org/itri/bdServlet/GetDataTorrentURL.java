 ...
 * @author A40385
 */
@WebServlet(urlPatterns = {"/getDataTorrentURL"})
public class GetDataTorrentURL extends HttpServlet{
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GetDataTorrentURL.class.getName()).log(Level.SEVERE, null, ex);
        } finally {            
            out.close();
        }
    }
