...
jLego.func.registerSite=function(name) {
    ...
    jLego[name].id = {};
    jLego[name].classs = {};
    jLego[name].cls = jLego[name].classs;
    jLego[name].url = {};
    jLego[name].languages = {};
    jLego[name].language = jLego[name].languages;
    jLego[name].lang = jLego[name].languages;
    jLego[name].variables = {};
    jLego[name].var = jLego[name].variables;
    jLego[name].constants = {};
    jLego[name].const = jLego[name].constants;
    jLego[name].functions = {};
    jLego[name].function = jLego[name].functions;
    jLego[name].func = jLego[name].functions;
    return jLego[name];
}
...
jLego.func.getUniqueKeyOfObject = function(objElement){
    var found = false;
    do{
        var newUUID = jLego.func.getRandomString();
        if(objElement[newUUID] == null){
            found = true;
            return newUUID;
        }
    }while(!found);
...
jLego.func.getImgPath=function(option){
    ...
    if(option.category==null && option.folder==null)   return false;
    else{
        ...
        if(option.folder){
            switch(option.folder){
                default:
                    path = jLego.url.rootUrl;
                    path+="/"+option.folder+"/"+option.name;
                    path+=imgType;
                    break;
            }
        }
...
jLego.func.sortObjectArrayByKey=function(array, key){
    var targetName = key;
    function SortByName(a, b){
        var aName = a[targetName];
        var bName = b[targetName]; 
