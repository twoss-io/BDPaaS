...
import org.itri.dataAccess.AuthDBManager;
...
public class DoLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Login loginData = authDBManager.doLogin(account, password);
            if(loginData.getResult()){
                request.getSession().setAttribute("userID", account);
                jsonResult.put(Key.ERR_CODE, Status.SUCCESS);
            }
            else{
                jsonResult.put(Key.ERR_CODE, Status.FAIL);
            }
